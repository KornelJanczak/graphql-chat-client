...
import { useMultiModalInput } from "@/common/hooks/chat/use-multimodal-input2";
import { cn } from "@/lib/utils";
import { TypingMesseges } from "./typing-messages";
...
export function MultimodalInput({
  ...
  console.log("MultimodalInput rendered with chatId:", typingUsers);

  return (
    <>
      {typingUsers && <TypingMesseges typingUsers={typingUsers} />}
      <form
